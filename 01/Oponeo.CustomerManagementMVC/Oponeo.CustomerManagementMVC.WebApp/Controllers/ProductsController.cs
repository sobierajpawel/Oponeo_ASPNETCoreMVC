...
namespace Oponeo.CustomerManagementMVC.WebApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(OponeoCustomerManagementMVCWebAppContext context)
        {
            _context = context;
        }
        ...
        //public IActionResult GetProducts(IEnumerable<Product> products)
        //{
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OponeoCustomerManagementMVCWebAppContext.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
